 ...
 */
package pe.cgonzales.hmsdemoapp.account;
...
import pe.cgonzales.hmsdemoapp.account.common.ICallBack;
import pe.cgonzales.hmsdemoapp.logger.Log;
    ...
    public void verify(String idToken, final ICallBack callBack) throws InvalidPublicKeyException, JWTDecodeException {
        ...
        getRSAPublicKeyByKidAsyn(decoder.getKeyId(), new ICallBack() {
            ...
            public void onSuccess() {
                ...
                } catch (JWTDecodeException | JSONException | Error | TokenExpiredException e){
                    callBack.onFailed();
                } catch (Exception e) {
                    callBack.onFailed();
