...
package pe.cgonzales.hmsdemoapp.iap;
...
import pe.cgonzales.hmsdemoapp.common.CipherUtil;
import pe.cgonzales.hmsdemoapp.common.Key;
...
public class DemoActivity extends Activity {
    ...
    private ProductInfoReq createProductInfoReq() {
        ...
        productIds.add("ConsumableGema1");
            ...
            switch(purchaseResultInfo.getReturnCode()) {
                case OrderStatusCode.ORDER_STATE_SUCCESS:
                    ...
                    boolean success = CipherUtil.doCheck(purchaseResultInfo.getInAppPurchaseData(),
                            purchaseResultInfo.getInAppDataSignature(), Key.getPublicKey());
                    if (success) {
